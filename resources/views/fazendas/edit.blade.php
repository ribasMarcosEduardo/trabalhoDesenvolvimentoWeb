        ...
        <div class="card shadow-lg">
            <div class="card-header">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <h4 class="mb-0 text-white">Editar Fazenda #{{ $fazenda->id }}</h4>
                </div>
            </div>
            ...
            <div class="card-body p-4">
                ...
                <form action="/fazendas/{{ $fazenda->id }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="nome" class="form-control" placeholder="Ex: Fazenda Boa Vista" value="{{ old('nome', $fazenda->nome) }}">
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="localizacao" class="form-control" placeholder="Ex: Município - Estado" value="{{ old('localizacao', $fazenda->localizacao) }}">
                        </div>
                    </div>
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <button type="submit" class="btn btn-salvar w-50 text-white">
                            <i class="bi bi-check-lg me-1"></i> Atualizar Fazenda
                        </button>
                    </div>
                </form>
            </div>
